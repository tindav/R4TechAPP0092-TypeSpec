...
using System;
namespace Ready4Tech.Kiota.Client.V1.Api.Dawnduskcalculation.Item {
    /// <summary>
    ...
    public class WithCalculationTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCalculationTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/api/dawnduskcalculation/{calculationType}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCalculationTypeItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCalculationTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/api/dawnduskcalculation/{calculationType}", rawUrl) {
        }
        /// <summary>
